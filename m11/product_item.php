			...
			<div class="col-xs-12 col-md-5">
				<form class="card soft" method="post" action="cart_actions.php?action=add-to-cart">
					...
					<div class="card-selection">
						...
						<div class="form-control">
							<label for="product-color" class="form-label product-item-form-label">Packaging</label>
							<div class="form-select">
								<select name="product-color" id="product-color">
									<option>Basic Box</option>
									<option>Special Box</option>
									<option>Box With Decorations</option>
									<option>Box With a Birthday Card</option>
								</select>
							</div>
						</div>
					</div>
